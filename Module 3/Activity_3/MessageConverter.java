...
/**
 * Program that converts message based on user input.
 *
 * Activity 3
 ...
 * Prints conversion examples to user with numeric value
 * Asks user for numeric input based on what conversion user wants
